...
public class labSpace extends NASA_mars_Habitas implements Serializable {
	
    private static final long serialVersionUID = 1L;

	
	public labSpace(double temperature,double humidity, double oxygenLevel, double pressure, double smokeDetection, double gasDetection,String errorMessage) {
