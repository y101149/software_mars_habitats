...
public class belowHeatingArea extends NASA_mars_Habitas implements Serializable{
	...
	public belowHeatingArea(double temperature,double humidity, double oxygenLevel, double pressure, double smokeDetection, double gasDetection, String errorMessage) {
