...
public class equipStorageSpace extends NASA_mars_Habitas implements Serializable{
	...
	public equipStorageSpace(double temperature,double humidity, double oxygenLevel, double pressure, double smokeDetection, double gasDetection, String errorMessage) {
