...
public class livingCell extends NASA_mars_Habitas implements Serializable{
	...
	public livingCell(double temperature,double humidity, double oxygenLevel, double pressure, double smokeDetection, double gasDetection, String errorMessage) {
	...
	public String toString() {
		// TODO Auto-generated method stub
		return "temperatuer" + Double.toString(temperature) + " humidity" + Double.toString(humidity) +
				" oxygenLevel" + Double.toString(oxygenLevel) + " perssure" + Double.toString(pressure) +
				" smokeDetection" + Double.toString(smokeDetection) + " gasDetection" + Double.toString(gasDetection);
	}
